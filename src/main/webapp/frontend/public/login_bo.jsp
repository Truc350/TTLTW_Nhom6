...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/frontend/css/publicCss/Authentic.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/frontend/css/publicCss/Register.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/frontend/css/publicCss/login.css">
    ...
    <form class="container-signup" action="${pageContext.request.contextPath}/login" method="post">
        ...
        <div class="container">
            ...
            <div class="social-buttons">
                ...
                <a class="facebook"
                   href="https://www.facebook.com/v19.0/dialog/oauth?client_id=<%=System.getenv("FACEBOOK_APP_ID")%>&redirect_uri=http://localhost:8080/TTLTW_Nhom6/login-facebook-callback&response_type=code&scope=email,public_profile">
