...
<footer class="footer">
    <div class="footer-container">
        <div class="footer-column">
            <div class="logo">
                <a href="${pageContext.request.contextPath}/frontend/public/homePage.jsp">
        ...
        <div class="footer-column">
            ...
            <ul>
                <li><a href="${pageContext.request.contextPath}/frontend/public/homePage.jsp">Trang chủ</a></li>
                <li><a href="${pageContext.request.contextPath}/frontend/public/FlashSale.jsp">Khuyến mãi</a></li>
                <li><a href="${pageContext.request.contextPath}/frontend/nguoiB/cart.jsp">Giỏ hàng</a></li>
                <li><a href="${pageContext.request.contextPath}/frontend/nguoiB/chat.jsp">Liên hệ</a></li>
            </ul>
        </div>
        <div class="footer-column">
            <h4><i class="fa-solid fa-headset"></i> Hỗ trợ khách hàng</h4>
            <ul>
                <li><a href="${pageContext.request.contextPath}/frontend/nguoiB/RefundPolicy.jsp">Chính sách đổi trả</a></li>
                <li><a href="${pageContext.request.contextPath}/frontend/nguoiB/shippingPolicy.jsp">Chính sách vận chuyển</a></li>
            </ul>
        </div>
        <div class="footer-column">
