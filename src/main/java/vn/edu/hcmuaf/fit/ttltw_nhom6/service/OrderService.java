...
import vn.edu.hcmuaf.fit.ttltw_nhom6.utils.CurrencyFormatter;
    ...
    private void formatReturnOrderData(Map<String, Object> returnOrder) {
        try {
            ...
            if (returnDateObj != null) {
                ...
                if (returnDateObj instanceof LocalDateTime) {
